  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Love Me Baked</a>
      </div>
  ...
  <div class="container" style="margin-top:20px;">
    <div class="row">
      <div class="col-md-3">
        ...
        <ul class="kategori">
          <?php
          $kategori = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM kategori_produk");
          while ($data = mysqli_fetch_array($kategori)) {
          ?>
            <li><a href="<?php echo $url; ?>menu.php?kategori=<?php echo $data['id'] ?>"><?php echo $data['nama']; ?> (
                <?php
                $ck = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM produk WHERE kategori_produk_id='$data[id]'"));
                if ($ck > 0) {
                  echo $ck;
                } else {
                  echo 0;
        ...
        <div style="width:100%; 
          ...
          if (isset($_SESSION['cart'])) {
            ...
            foreach ($cart as $id => $qty) {
              $product = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from produk WHERE id='$id'"));
              if (isset($product)) {
                $t = $qty * $product['harga'];
                $total += $t;
              }
          ...
          <a style="color:#darkblue;" href="<?php echo $url; ?>keranjang.php">Lihat Detail</a>
        </div>
        ...
        <div class="row col-md-12">
          <hr>
          <a href="https://www.instagram.com/lovemebaked/?hl=id" target="_blank"><img src="<?php echo $url . 'assets/img/gambarsamping1.png'; ?>" width="100%"></a><br><br>
          <img src="<?php echo $url . 'assets/img/gambarsamping2.png'; ?>" width="100%"><br><br>
          <a href="https://api.whatsapp.com/send?phone=6281381295930&text=Hai...%20saya%20mau%20pesan%20cookies" target="_blank"><img src="<?php echo $url . 'assets/img/gambarsamping3.png'; ?>" width="100%"></a><br><br>
        </div>
      </div>
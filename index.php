...
?>
		...
		<div class="col-md-9">
			...
			<h3>Favorite</h3>
				...
				<?php 
					$k = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM produk ORDER BY id ASC limit 3"); 
			...
			<h3>New</h3>
				<?php 
					$k = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM produk ORDER BY id DESC limit 3"); 
					while($data = mysqli_fetch_array($k)){
				?>
				<div class="col-md-4 content-menu">
					<a href="<?php echo $url; ?>menu.php?id=<?php echo $data['id'] ?>">

<?php 
	...
	if(!empty($_POST)){
		...
		$q = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `user` WHERE email='$email' AND password='$password' AND status='user'")or die(mysqli_error($GLOBALS["___mysqli_ston"]));
		if($q){
